...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col bg-black overflow-x-hidden selection:bg-indigo-500/30 selection:text-white">
      <Hero />
      <NarrativeSection />

      {/* Product Teaser: Aether Bloc */}
      <section className="py-32 md:py-40 text-white relative overflow-hidden">
        {/* Rich background */}
        <div className="absolute inset-0 bg-gradient-to-b from-black via-zinc-950/80 to-black" />
        <div className="absolute top-0 right-0 w-[700px] h-[700px] bg-indigo-500/[0.04] rounded-full blur-[180px] animate-drift pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-emerald-500/[0.03] rounded-full blur-[150px] animate-drift-delayed pointer-events-none" />
        <div
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            >
              <Link href="/products/bloc">
                <div className="aspect-square bg-zinc-900/50 rounded-2xl border border-white/[0.06] flex items-center justify-center relative overflow-hidden group cursor-pointer glow-card">
                  <Image
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight text-white glow-text">
                Aether Bloc
              </h2>
              ...
              <p className="text-2xl md:text-3xl font-bold text-white mb-8">Rs. 12,999</p>
              <Link
                href="/products/bloc"
      ...
      {/* Footer */}
      <footer className="py-12 md:py-16 text-center text-zinc-600 text-sm border-t border-white/[0.06] relative">
